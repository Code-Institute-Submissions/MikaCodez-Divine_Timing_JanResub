"""
Django settings for divine_timing project.
...
ROOT_URLCONF = 'divine_timing.urls'
...
WSGI_APPLICATION = 'divine_timing.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'divinetiming'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'divinetiming@example.com'
else:
